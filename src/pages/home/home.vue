		...
		<div class="body">
			...
			<div class="box">
				<div class="centre" v-if="cate_list.length">
					...
					<div class="centre_nai_li" @click="service_list(cate_list[3].id)">
						<div class="centre_div_le_text">
					...
					<div class="centre_nai_li" style="margin-top: -0.5rem;" @click="service_list(cate_list[6].id)">
						...
						<div class="centre_div_le_text">
							...
							<span>{{cate_list[6].cate_remark ? '' : '深度保洁'}}</span>
						</div>
						<div class="centre_div_le_img imgs1">
							<img :src="cate_img_list[7]" />
						</div>
					</div>
				...
				<div class="centre_nai">
					<ul>
						<li v-if="index>4" class="centre_nai_li flex" v-for="(item,index) in cate_list" @click="service_list(item.id)">
